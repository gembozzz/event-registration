    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                $isFull = $slotsLeft <= 0; @endphp @if (session('success')) <div
            ...
            <p><strong>🎯 Link Event:</strong>
                <a href="{{ $event->link }}" target="_blank" class="text-decoration-none text-success fw-semibold">
                    {{ $event->link }}
                </a>
            </p>
            @endif
            ...
            <a href="https://wa.me/{{ $event->whatsapp_admin }}" target="_blank" class="btn btn-success w-100">
